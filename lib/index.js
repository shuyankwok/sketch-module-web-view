...
function BrowserWindow(options) {
  ...
  // inject 可以自定义非Panel的父window
  var panel = options.notPanelWindow
    ? options.notPanelWindow
    : NSPanel.alloc().initWithContentRect_styleMask_backing_defer(
        cocoaBounds,
        styleMask,
  ...
  // FIXME: 这部分应当是在父window中完成
  if (options.notPanelWindow) {
    console.log('notPanelWindownotPanelWindownotPanelWindow')
    contentView.addSubview(webView)

    // Constraint - X, Y
    var constraintCenterX = NSLayoutConstraint.constraintWithItem_attribute_relatedBy_toItem_attribute_multiplier_constant(
      webView,
    ...
    var constraintBottom = NSLayoutConstraint.constraintWithItem_attribute_relatedBy_toItem_attribute_multiplier_constant(
      webView,
    ...
    var constraintWidth = NSLayoutConstraint.constraintWithItem_attribute_relatedBy_toItem_attribute_multiplier_constant(
      webView,
    ...
    var constraintHeight = NSLayoutConstraint.constraintWithItem_attribute_relatedBy_toItem_attribute_multiplier_constant(
      webView,
    ...
    webView.addConstraint(constraintWidth)
